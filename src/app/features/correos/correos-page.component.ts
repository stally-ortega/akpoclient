  ...
  template: `
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold text-slate-900">Envío de Correos</h1>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-6">
          <section class="bg-white rounded-xl shadow-sm p-6 border border-slate-100">
            <h2 class="text-lg font-semibold text-slate-900 mb-4">Cargar Archivo</h2>
            <app-upload-form 
          ...
          <section *ngIf="isProcessing() || currentStatus()" class="bg-white rounded-xl shadow-sm p-6 border border-slate-100">
            <h2 class="text-lg font-semibold text-slate-900 mb-4">Estado del Proceso</h2>
        ...
        <!-- Right Column: Results -->
         <div class="space-y-6">
          <section class="bg-white rounded-xl shadow-sm p-6 border border-slate-100 h-full">
